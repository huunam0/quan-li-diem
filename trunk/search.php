...
echo "<input type='radio' name='method' id='OR' value='OR'".($_GET['method'] == "OR" ? " checked='checked'" : "")." /> <label for=\"OR\">".$locale['403']."</label><br  />\n";
echo "<input type='radio' name='method' id='AND' value='AND'".($_GET['method'] == "AND" ? " checked='checked'" : "")." /> <label for=\"AND\">".$locale['404']."</label></td>\n";
echo "</tr>\n<tr>\n";
...
echo "<tr>\n";
echo "<td><input type='radio' name='stype' id='stype' value='all'".($_GET['stype'] == "all" ? " checked='checked'" : "")." onclick=\"display(this.value)\" /> <label for=\"stype\">".$locale['407']."</label></td>\n";
echo "</tr>\n</table>\n</td>\n";
...
echo "<td class='tbl1'><input type='radio' id='fields1' name='fields' value='2'".($_GET['fields']==2?" checked='checked'":"").($_GET['stype']!="all"?(in_array("fields1", $form_elements[$_GET['stype']]['disabled'])?" disabled='disabled'":""):"")." /> <label for=\"fields1\">".$locale['430']."</label><br  />\n";
echo "<input type='radio' id='fields2' name='fields' value='1'".($_GET['fields']==1?" checked='checked'":"").($_GET['stype']!="all"?(in_array("fields2", $form_elements[$_GET['stype']]['disabled'])?" disabled='disabled'":""):"")." /> <label for=\"fields2\">".$locale['431']."</label><br  />\n";
echo "<input type='radio' id='fields3' name='fields' value='0'".($_GET['fields']==0?" checked='checked'":"").($_GET['stype']!="all"?(in_array("fields3", $form_elements[$_GET['stype']]['disabled'])?" disabled='disabled'":""):"")." /> <label for=\"fields3\">".$locale['432']."</label></td>\n";
echo "</tr>\n<tr>\n";
...
echo "</tr>\n<tr>\n";
echo "<td class='tbl1'>&nbsp;</td>\n";
echo "<td class='tbl1'><input type='radio' id='order1' name='order' value='0'".($_GET['order']==0?" checked='checked'":"").($_GET['stype']!="all"?(in_array("order1", $form_elements[$_GET['stype']]['disabled'])?" disabled='disabled'":""):"")." /> <label for=\"order1\">".$locale['450']."</label><br  />\n";
echo "<input type='radio' id='order2' name='order' value='1'".($_GET['order']==1?" checked='checked'":"").($_GET['stype']!="all"?(in_array("order2", $form_elements[$_GET['stype']]['disabled'])?" disabled='disabled'":""):"")." /> <label for=\"order2\">".$locale['451']."</label><br  /></td>\n";
echo "</tr>\n<tr>\n";
...
function search_navigation($rows) {
        ...
        $navigation_result = "<div align='center' style='margin-top:5px;'>\n".makePageNav($_GET['rowstart'], 10, ($site_search_count > 100 || search_globalarray("") ? 100 : $site_search_count), 3, FUSION_SELF."?stype=".$_GET['stype']."&amp;stext=".$_GET['stext']."&amp;".$composevars)."\n</div>\n";
