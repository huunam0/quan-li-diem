...
for ($i=0; $i < $code_count; $i++) {
        ...
        $text = preg_replace("#\[code\](.*?)\[/code\]#sie", "'<div class=\'tbl-border tbl2\' style=\'width: 500px\'>".$code_save."<strong>".$locale['bb_code_code']."</strong></div><div class=\'tbl-border tbl1\' style=\'width: 500px;white-space:nowrap;overflow:auto\'><code style=\'white-space:nowrap\'>'.formatcode('\\1').'<br /><br /><br /></code></div>'", $text, 1);
}
?>
