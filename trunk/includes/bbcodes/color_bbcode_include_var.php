...
"onmouseover"		=>	"",
"onmouseout"		=>	"",
"html_start"		=>	"<div id='bbcode_color_map_".$textarea_name."' class='tbl1' style='display:none;border:1px solid black;position:absolute;width:220px;height:160px' onclick=\"overlayclose('bbcode_color_map_".$textarea_name."');\">",
