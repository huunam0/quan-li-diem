...
function D2A($year, $month, $day) {
	$al=convertSolar2Lunar($day,$month,$year,7.0);
	$can = array("Canh","Tân","Nhâm","Quý","Giáp","Ất","Bính","Đinh","Mậu","Kỷ");
	$chi = array("Thân","Dậu","Tuất","Hợi","Tí","Sửu","Dần","Mẹo","Thìn","Tỵ","Ngọ","Mùi");
	return $al[0]."/".$al[1].($al[3]==1?"*":"")." ".$can[$al[2] % 10]." ".$chi[$al[2] % 12];
}
function D2A2($date) {
