...
"includejscript"	=>	"",
"calljscript"		=>	"",
"html_start"		=>	"<div id='bbcode_text_size_".$textarea_name."' class='tbl1' style='display: none; border:1px solid black; position: absolute; width: 50px; height: auto; text-align: center' onclick=\"overlayclose('bbcode_text_size_".$textarea_name."');\">",
