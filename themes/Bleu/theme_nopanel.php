...
function render_page() {
		...
		*/
		...
		echo "<td class='main-bg' valign='top'>".CONTENT."</td>";
...
function opentable($title) {
        ...
        echo "<table cellpadding='0' cellspacing='0' width='100%' style='border: 1px solid #5dc0ff; border-bottom: 0px;'>\n<tr>\n";
        echo "<td class='capmain-left'></td>\n";
        echo "<td class='capmain'><strong>".$title."</td>\n";
        echo "<td class='capmain-right'></td>\n";
        echo "</tr>\n</table>\n";
        echo "<table cellpadding='0' cellspacing='0' width='100%' class='spacer' style='border: 1px solid #5dc0ff; border-top: 0px;'>\n<tr>\n";
...
function openside($title, $collapse = false, $state = "on") {
        ...
        echo "<table cellpadding='0' cellspacing='0' width='100%' style='border: 1px solid #b0fb88; border-bottom: 0px;'>\n<tr>\n";
        ...
        echo "</tr>\n</table>\n";
        echo "<table cellpadding='0' cellspacing='0' width='100%' class='spacer' style='border: 1px solid #b0fb88; border-top: 0px;'>\n<tr>\n";
